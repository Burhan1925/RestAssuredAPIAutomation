...
public class BaseTest {
    ...
    protected Response createBooking(){
        Response response = given(spec)
                ...
                .body(bookingObject("Burhan","Aydın",100,true))
                .post("/booking");
    ...
    protected String bookingObject(String firsName, String lastName, int totalPrice, boolean depositPaid){
        JSONObject body = new JSONObject();
        body.put("firstname",firsName);
